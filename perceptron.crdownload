...
##1.activation_fn; x değeri 0'dan büyük eşitse 1, 0'dan küçükse 0 değeri döndüren bir fonksiyondur.Predict fonksiyonu gelen verinin(x) başına bir tane 1 koyar b0 olarak.Sonra z yi üretir, a'da z'den activation_fn'la ürettiği 1 veya 0 değerleridir.Fit fonksiyonu x ve d'yi alarak W'yi ve e'yi belirler yani W'leri günceller.
